...
async function exportUsersFeb5Excel() {
    try {
        ...
        const filteredCount = users.filter(user => {
            ...
            return dateObj.getDate() === 5 && dateObj.getMonth() === 1;
        }).length;
        
        console.log(`📊 5-fevral kuni: ${filteredCount} ta\n`);
        ...
        const fileName = 'users-5-fevral-2026.csv';
        ...
        users.forEach((user, index) => {
            ...
            // Faqat 5-fevral kunini olish
            if (dateObj.getDate() !== 5 || dateObj.getMonth() !== 1) { // 1 = fevral (0-indexed)
                return;
            }
