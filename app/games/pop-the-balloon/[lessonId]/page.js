...
export default function PopTheBalloonGame() {
    ...
    const handleBalloonClick = useCallback(async (balloonId, balloonColor) => {
        ...
        if (isCorrect) {
            ...
            if (newScore >= TARGET_SCORE) {
                // O'yin tugadi - progress saqlaymiz
    ...
    }, [score, gameActive, targetColor, selectNextColor, mistakes, studentId, lessonId]);
