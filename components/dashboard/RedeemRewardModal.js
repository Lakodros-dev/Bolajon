                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="modal-body">
                            ...
                            <div className="d-flex gap-3 p-3 rounded-4 mb-4" style={{ backgroundColor: '#f6f7f8' }}>
                                ...
                                >
                                    {reward?.icon ? (
                                        <span className="material-symbols-outlined filled" style={{ fontSize: '32px' }}>{reward.icon}</span>
                                    ) : (
                            ...
                            <div className="mb-3">
                                ...
                                {fetchingStudents ? (
                                    ...
                                    <div className="alert alert-warning rounded-3 small mb-0">
                                        <span className="material-symbols-outlined me-2" style={{ fontSize: '18px' }}>warning</span>
